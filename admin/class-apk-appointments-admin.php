 ...
 * @subpackage APK_Appointments/admin
 */
...
class APK_Appointments_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $apk_appointments       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->apk_appointments, plugin_dir_url( __FILE__ ) . 'css/apk-appointments-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->apk_appointments, plugin_dir_url( __FILE__ ) . 'js/apk-appointments-admin.js', array( 'jquery' ), $this->version, false );
