...
class APK_Appointments_Settings_Test extends WP_UnitTestCase {
	...
	public function test_values_of_fee_is_present_for_1800() {
		...
		$this->assertEquals( '£20.00', $this->settings->get_fee_for_time( $monday_fee_options, 9 ) );
	}
	...
	private function expected_checkbox_array() {
		return array(
			array(
				...
				'uid_fee' => 'apk_monday_appointment_fee',
				'label'   => 'Monday',
			...
			array(
				...
				'uid_fee' => 'apk_tuesday_appointment_fee',
				'label'   => 'Tuesday',
				'section' => 'appointment_availability_section',
				'type'    => 'time_fee',
				'options' => array(
			...
			array(
				...
				'uid_fee' => 'apk_wednesday_appointment_fee',
				'label'   => 'Wednesday',
				'section' => 'appointment_availability_section',
				'type'    => 'time_fee',
				'options' => array(
			...
			array(
				...
				'uid_fee' => 'apk_thursday_appointment_fee',
				'label'   => 'Thursday',
				'section' => 'appointment_availability_section',
				'type'    => 'time_fee',
				'options' => array(
			...
			array(
				...
				'uid_fee' => 'apk_friday_appointment_fee',
				'label'   => 'Friday',
				'section' => 'appointment_availability_section',
				'type'    => 'time_fee',
				'options' => array(
			...
			array(
				...
				'uid_fee' => 'apk_saturday_appointment_fee',
				'label'   => 'Saturday',
				'section' => 'appointment_availability_section',
				'type'    => 'time_fee',
				'options' => array(
			...
			array(
				...
				'uid_fee' => 'apk_sunday_appointment_fee',
				'label'   => 'Sunday',
				'section' => 'appointment_availability_section',
				'type'    => 'time_fee',
				'options' => array(
